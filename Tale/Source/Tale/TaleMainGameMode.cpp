...
ATaleMainGameMode::ATaleMainGameMode()
	: RespawnDelaySeconds(1.0f)
{
}

void ATaleMainGameMode::PlayerDied(AController* Controller)
{
	...
	RespawnDelegate = FTimerDelegate::CreateUObject(this, &ATaleMainGameMode::RespawnPlayer, Controller);
...
void ATaleMainGameMode::RespawnPlayer(AController* Controller)
{
